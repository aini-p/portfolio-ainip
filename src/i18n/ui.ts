...
export const ui = {
  ja: {
    ...
    "comments.namePlaceholder": "お名前（任意）",
    "comments.bodyPlaceholder": "コメントを書く",
    "comments.submit": "投稿する",
    "comments.sending": "送信中...",
    "comments.error": "投稿に失敗しました。時間をおいて再度お試しください。",
    "comments.rateLimited": "少し時間をおいてから投稿してください。",
    "comments.anonymous": "名無しさん",
    ...
    "membership.pageDescription":
      "Patreonメンバーシップの特典・Tier比較ページです。",
    "membership.heading": "メンバーシップに参加する",
    "membership.lead":
      "月々のサポートで、限定イラストや制作の裏側をお楽しみいただけます。ご自身に合ったTierをお選びください。",
    "membership.tierCta": "このTierに登録する",
  ...
  en: {
    ...
    "comments.error": "Couldn't post your comment. Please try again later.",
    "comments.rateLimited": "Please wait a moment before posting again.",
    ...
    "membership.pageDescription": "Compare Patreon membership tiers and perks.",
    "membership.heading": "Join the membership",
    "membership.lead":
      "Support monthly to unlock exclusive artwork and behind-the-scenes updates. Pick the tier that fits you.",
    "membership.tierCta": "Join this tier",
